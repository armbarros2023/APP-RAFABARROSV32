...
const ForgotPasswordPage: React.FC = () => {
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-8 text-white">
            <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(45,212,191,0.22),transparent_22%),radial-gradient(circle_at_bottom_right,rgba(14,165,233,0.18),transparent_26%),linear-gradient(180deg,#06211e_0%,#0b2b28_42%,#071918_100%)]" />
            <div className="w-full max-w-sm mx-auto p-4">

                <div className="text-center mb-8">
                    <div className="inline-block p-4 bg-white/10 rounded-[22px] mb-4 border border-white/10">
                ...
                {!submitted ? (
                    <form onSubmit={handleSubmit} className="space-y-6 glass-surface p-8 rounded-[30px] border border-white/20 shadow-2xl">
                        <div className="relative flex items-center">
                            ...
                            <input
                                ...
                                className="w-full rounded-2xl border border-white/18 bg-white/6 py-3 pl-10 pr-3 text-white outline-none transition-all placeholder:text-white/45 focus:border-white/40 focus:bg-white/10 focus:ring-4 focus:ring-white/10"
                            />
                        </div>
                    ...
                    <div className="text-center space-y-6 glass-surface p-8 rounded-[30px] border border-white/20 shadow-2xl animate-fade-in">
