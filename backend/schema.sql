...
-- CreateEnum
CREATE TYPE "StaffStatus" AS ENUM ('ACTIVE', 'ON_VACATION', 'INACTIVE');

-- CreateEnum
CREATE TYPE "StudentStatus" AS ENUM ('ACTIVE', 'INACTIVE');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('PIX', 'DEBITO', 'CREDITO_RECORRENTE', 'FIDELIDADE_TRIMESTRAL', 'FIDELIDADE_SEMESTRAL', 'FIDELIDADE_ANUAL');

-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('SCHEDULED', 'CANCELLED', 'COMPLETED', 'PENDING_ACCEPTANCE');

-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('REVENUE', 'EXPENSE');

-- CreateEnum
CREATE TYPE "FinancialCategory" AS ENUM ('RECEITA_ATENDIMENTO', 'RECEITA_CURSO', 'RECEITA_KIT', 'CUSTO_FIXO', 'CUSTO_VARIAVEL', 'INVESTIMENTO', 'CAPITAL_GIRO');
...
-- CreateEnum
CREATE TYPE "AssessmentStatus" AS ENUM ('SCHEDULED', 'COMPLETED');
